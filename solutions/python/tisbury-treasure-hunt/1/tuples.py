...
def compare_records(azara_record, rui_record):
    ...
    rui_coord_str = "".join(rui_coord_tuple)

    return azara_coord == rui_coord_str
...
def clean_up(combined_record_group):
    ...
    for record in combined_record_group:
        ...
        report_line = f"('{treasure}', '{location}', {coordinate_tuple}, '{quadrant}')"
        cleaned_reports.append(report_line)
